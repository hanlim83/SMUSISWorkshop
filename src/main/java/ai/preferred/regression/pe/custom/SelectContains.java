...
public class SelectContains extends ProcessingElement {

    private static final Logger LOGGER = LoggerFactory.getLogger(SelectContains.class);
    ...
    public static void main(String[] args) {
        parseArgsAndRun(SelectContains.class, args);
    }
    ...
    protected void process(CSVInputData data, CSVPrinter printer) throws IOException {
        ...
        for (final ArrayList<String> record : data) {
            if (record.get(column).contains(value)) {
