...
public class SelectNotEquals extends ProcessingElement {

    private static final Logger LOGGER = LoggerFactory.getLogger(SelectNotEquals.class);
    ...
    public static void main(String[] args) {
        parseArgsAndRun(SelectNotEquals.class, args);
    }
